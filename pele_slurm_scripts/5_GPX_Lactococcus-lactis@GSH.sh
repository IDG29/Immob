#!/bin/bash
#SBATCH --job-name=5_GPX_Lactococcus-lactis@GSH
#SBATCH --qos=bsc_ls
#SBATCH --time=48:0:00
#SBATCH --ntasks 96
#SBATCH --output=5_GPX_Lactococcus-lactis@GSH_%a_%A.out
#SBATCH --error=5_GPX_Lactococcus-lactis@GSH_%a_%A.err
...
cd pele/GPX_Lactococcus-lactis@GSH
python -m pele_platform.main input.yaml
python ../._correctPositionalConstraints.py output output/input/GPX_Lactococcus-lactis@GSH@12_processed.pdb

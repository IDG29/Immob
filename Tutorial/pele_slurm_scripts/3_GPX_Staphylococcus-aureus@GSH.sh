#!/bin/bash
#SBATCH --job-name=3_GPX_Staphylococcus-aureus@GSH
#SBATCH --qos=bsc_ls
#SBATCH --time=48:0:00
#SBATCH --ntasks 96
#SBATCH --output=3_GPX_Staphylococcus-aureus@GSH_%a_%A.out
#SBATCH --error=3_GPX_Staphylococcus-aureus@GSH_%a_%A.err
...
cd pele/GPX_Staphylococcus-aureus@GSH
python -m pele_platform.main input.yaml
python ../._correctPositionalConstraints.py output output/input/GPX_Staphylococcus-aureus@GSH@5_processed.pdb
